...
# 
folderName = "compResult/" # Name of the folder storing the data
...
cs1 = ax1.contourf(X, Y, propGuardMaxStress, cmap = 'GnBu',levels = levels)
ax1.set_ylabel('angle 2', fontsize=18)
ax1.set_xlabel('angle 1', fontsize=18)
ax1.tick_params(labelsize=18)
ax1.set_title('Max Stress:Prop-guard', fontsize=18)
ax1.set_aspect('equal')

cs2 = ax2.contourf(X, Y, tensegrityMaxStress, cmap = 'GnBu',levels = levels)
ax2.set_xlabel('angle 1', fontsize=18)
